...
class _ServicesScreenState extends State<ServicesScreen> {
  // Couleurs déclarées comme final (non-const)
  ...
  final Color _jaune = const Color(0xFFFFC107); // Nouvelle couleur pour le service d'achat
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Grille des services (maintenant 3x3 avec le nouveau service)
              GridView.builder(
                shrinkWrap: true,
                physics: const NeverScrollableScrollPhysics(),
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 3, // Passé de 2 à 3 pour mieux accommoder 7 services
                  crossAxisSpacing: 12,
                  mainAxisSpacing: 12,
  ...
  Widget _buildRecentRequest(String type, String description, String statut, Color statutColor) {
    return Container(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(
              type == 'Achat' ? Icons.shopping_cart : Icons.build,
              color: statutColor,
              size: 18,
            ),
          ),
