...
class AddServiceAgentScreen extends StatefulWidget {
  @override
  _AddServiceAgentScreenState createState() => _AddServiceAgentScreenState();
}

class _AddServiceAgentScreenState extends State<AddServiceAgentScreen> {
  ...
  Future<void> _saveAgent() async {
    ...
    try {
      final success = await ApiService.addServiceAgent({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Ajouter un agent de service'),
