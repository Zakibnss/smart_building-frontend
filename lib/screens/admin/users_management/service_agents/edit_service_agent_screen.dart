...
class EditServiceAgentScreen extends StatefulWidget {
  final User agent;

  const EditServiceAgentScreen({Key? key, required this.agent}) : super(key: key);

  @override
  _EditServiceAgentScreenState createState() => _EditServiceAgentScreenState();
}

class _EditServiceAgentScreenState extends State<EditServiceAgentScreen> {
  ...
  final List<String> _statuses = ['Disponible', 'Absent', 'En intervention'];
  ...
  Future<void> _updateAgent() async {
    ...
    try {
      ...
      final success = await ApiService.updateServiceAgent(widget.agent.id, data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Modifier un agent de service'),
